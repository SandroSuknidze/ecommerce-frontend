...
export function Header() {
    ...
    return (
        <header className={`flex flex-row border-y-[1px] border-y-[#ebebeb] bg-white transform duration-500  w-full ${isVisible ? 'translate-y-0 fixed z-20 ' : ''} `}>
                            ...
                            {dropdown && (
                                <div
                                    ...
                                    <div onClick={() => selectLanguage("en")}
                                        ...
                                        {language === 'en' && <Image src={correctIcon} alt="" className="w-[10px]"/>}
                                    </div>
                                    <div onClick={() => selectLanguage("geo")}
                                         className="flex gap-2 cursor-pointer px-[10px] py-[5px] hover:bg-blue-600">
                                        <Image src={geo} alt="" width="20" className=""/>
                                        {language === 'geo' && <Image src={correctIcon} alt="" className="w-[10px]"/>}
                                    </div>
                                </div>
                            )}
